...
public class ErschemaPackageImpl extends EPackageImpl implements ErschemaPackage {
	 ...
	 * @see de.tu_bs.cs.isf.mbse.erschema_branch.ErschemaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(numberEClass, de.tu_bs.cs.isf.mbse.erschema_branch.Number.class, "Number", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(stringEClass, de.tu_bs.cs.isf.mbse.erschema_branch.String.class, "String", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(integerEClass, de.tu_bs.cs.isf.mbse.erschema_branch.Integer.class, "Integer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(booleanEClass, de.tu_bs.cs.isf.mbse.erschema_branch.Boolean.class, "Boolean", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(doubleEClass, de.tu_bs.cs.isf.mbse.erschema_branch.Double.class, "Double", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
