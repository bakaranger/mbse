 ...
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.erschema.impl.GreaterThanImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GreaterThanImpl extends ComparativeImpl implements GreaterThan {
	/**
	...
	protected EClass eStaticClass() {
		return ErschemaPackage.Literals.GREATER_THAN;
	}
	...
	public EList<Double> getValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<Double>(Double.class, this, ErschemaPackage.GREATER_THAN__VALUE);
		}
		return value;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ErschemaPackage.GREATER_THAN__VALUE:
				return getValue();
		}
