 ...
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.erschema.impl.ModuloImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ModuloImpl extends ArithmeticOperatorImpl implements Modulo {
	/**
	...
	protected EClass eStaticClass() {
		return ErschemaPackage.Literals.MODULO;
	}
	...
	public EList<Double> getValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<Double>(Double.class, this, ErschemaPackage.MODULO__VALUE);
		}
		return value;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ErschemaPackage.MODULO__VALUE:
				return getValue();
		}
