 ...
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.erschema.impl.AddImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddImpl extends ArithmeticOperatorImpl implements Add {
	...
	protected EClass eStaticClass() {
		return ErschemaPackage.Literals.ADD;
	}
	...
	public EList<Double> getValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<Double>(Double.class, this, ErschemaPackage.ADD__VALUE);
		}
		return value;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ErschemaPackage.ADD__VALUE:
				return getValue();
		}
