 ...
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.erschema.impl.GreaterImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GreaterImpl extends ComparativeImpl implements Greater {
	/**
	...
	protected EClass eStaticClass() {
		return ErschemaPackage.Literals.GREATER;
	}
	...
	public EList<Double> getValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<Double>(Double.class, this, ErschemaPackage.GREATER__VALUE);
		}
		return value;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ErschemaPackage.GREATER__VALUE:
				return getValue();
		}
