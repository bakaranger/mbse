...
public class ErschemaAdapterFactory extends AdapterFactoryImpl {
	...
	protected ErschemaSwitch<Adapter> modelSwitch =
		new ErschemaSwitch<Adapter>() {
			...
			@Override
			public Adapter casePredicateOperator(PredicateOperator object) {
				return createPredicateOperatorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.mbse.erschema.Constraint <em>Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.mbse.erschema.Predicate <em>Predicate</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.mbse.erschema.Term <em>Term</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.mbse.erschema.PredicateOperator <em>Predicate Operator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPredicateOperatorAdapter() {
		return null;
	}
